...
# Change the default output directory in the build structure. This is not
# stricly needed, but helps running in Windows, such that all built executables
# have DLLs in the same folder as the .exe files.
...
option(MUJOCO_ENABLE_AVX
       "Build binaries that require AVX instructions, if possible." ON)
option(MUJOCO_ENABLE_AVX_INTRINSICS
       "Make use of hand-written AVX intrinsics, if possible." ON)
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR (CMAKE_CXX_COMPILER_ID MATCHES
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    # Set -Wimplicit-fallthrough=5 to only allow fallthrough annotation via
    # __attribute__.
